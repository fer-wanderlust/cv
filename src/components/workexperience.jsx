                ...
                <div className="timeline-centered">
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Full Stack Web Development <span>November 2017 - Present </span></h2>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2> Visit Researcher at Advanced Real-Time Simulation Lab <span> January 2017 - July 2017 </span></h2>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2> .Net Developer <span> November 2013 - July 2016 </span></h2>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2> Web developer <span> Novemer 2012 - October 2013 </span></h2>
